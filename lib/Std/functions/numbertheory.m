...
Definitions`EvenQ = {Hold[ EvenQ[n_Integer] := Mod[n,2]===0; ]};
...
Definitions`OddQ = {Hold[ OddQ[n_Integer] := Mod[n,2]===1; ]};
...
Definitions`FactorInteger = {Hold[
...
Definitions`FractionalPart = {Hold[
...
Definitions`IntegerDigits = {Hold[
