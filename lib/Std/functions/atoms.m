...
FunctionDefinition`IntegerQ = {Hold[IntegerQ[e_] := Head[e] === Integer;]};
...
FunctionDefinition`realNumberQ = {
    Hold[
...
FunctionDefinition`ReIm = {Hold[ReIm[x_] := {Re[x], Im[x]};]};
