...
Definitions`I = {Hold[I := Complex[0, 1];]}
...
Definitions`CoefficientAux = {Hold[
...
Definitions`CoefficientList = {Hold[
...
Definitions`PolynomialQuotientRemainder = {Hold[
...
Definitions`PolynomialQuotient = {Hold[
...
Definitions`PolynomialRemainder = {Hold[
...
Definitions`FactorTermsList = {Hold[
...
Definitions`ExpreduceFactorConstant = {Hold[
...
Definitions`PolynomialGCD = {Hold[
...
Definitions`FractorSquareFreeAux = {Hold[
...
Definitions`FactorSquareFree = {Hold[
...
Definitions`Factor = {Hold[Factor[poly_] := poly;]};
...
Definitions`Conjugate = {Hold[Conjugate[a_] := a - 2 Im[a] I ;/ (FreeQ[Im[a], Re] && FreeQ[Im[a], Im]);]};
...
Definitions`ComplexExpand {Hold[
