...
Definitions`Save = {Hold[ Save[fn_String, pattern_String] := Save[fn, syms] /. syms -> Names[pattern]; ]};
...
(* TODO: Fix this hack. *)
Definitions`Block = {Hold[ Block[args___] := Module[args]; ]};
...
Definitions`ClearAttributes = {Hold[
...
Definitions`TimeConstrained = {Hold[
